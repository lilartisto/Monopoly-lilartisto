public class Map{
    ...
    private void prepare(){
        ...
        fields[1] = new StreetF("A1", 60, "\u001b[48;5;90m" );
        fields[2] = new CardF("CHEST 1");
        fields[3] = new StreetF("A2", 60, "\u001b[48;5;90m" );
        fields[4] = new TaxF("Tax 200");
        fields[5] = new StationF("S1", 200, "\u001b[48;5;7m" );
        fields[6] = new StreetF("B1", 100, "\u001b[48;5;13m" );
        fields[7] = new CardF("CHANCE?");
        fields[8] = new StreetF("B2", 100, "\u001b[48;5;13m" );
        fields[9] = new StreetF("B3", 120, "\u001b[48;5;13m" );
        fields[10] = new JailF("JAIL");
        fields[11] = new StreetF("C1", 140, "\u001b[48;5;198m" );
        fields[12] = new BuildingF("BE", 150);
        fields[13] = new StreetF("C2", 140, "\u001b[48;5;198m" );
        fields[14] = new StreetF("C3", 160, "\u001b[48;5;198m" );
        fields[15] = new StationF("S2", 200, "\u001b[48;5;7m" );
        fields[16] = new StreetF("D1", 180, "\u001b[48;5;208m" );
        fields[17] = new CardF("CHEST 2");
        fields[18] = new StreetF("D2", 180, "\u001b[48;5;208m" );
        fields[19] = new StreetF("D3", 180, "\u001b[48;5;208m" );
        fields[20] = new ParkingF("PARKING");
        fields[21] = new StreetF("E1", 220, "\u001b[48;5;1m" );
        fields[22] = new CardF("CHANCE?");
        fields[23] = new StreetF("E2", 220, "\u001b[48;5;1m" );
        fields[24] = new StreetF("E3", 240, "\u001b[48;5;1m" );
        fields[25] = new StationF("S3", 200, "\u001b[48;5;7m" );
        fields[26] = new StreetF("F1", 260, "\u001b[48;5;3m" );
        fields[27] = new StreetF("F2", 260, "\u001b[48;5;3m" );
        fields[28] = new BuildingF("BW", 150);
        fields[29] = new StreetF("F3", 280, "\u001b[48;5;3m" );
        fields[30] = new PoliceF("GO2JAIL");
        fields[31] = new StreetF("G1", 300, "\u001b[48;5;2m" );
        fields[32] = new StreetF("G2", 300, "\u001b[48;5;2m" );
        fields[33] = new CardF("CHEST 3");
        fields[34] = new StreetF("G3", 320, "\u001b[48;5;2m" );
        fields[35] = new StationF("S4", 200, "\u001b[48;5;7m" );
        fields[36] = new CardF("CHANCE?");
        fields[37] = new StreetF("H1", 350, "\u001b[48;5;4m" );
        fields[38] = new TaxF("TAX 100");
        fields[39] = new StreetF("H2", 400, "\u001b[48;5;4m" );
    }
    ...
    public void printMap( Player player ){
        ...
        System.out.println("|"+fields[13].line2()+"|                              $ "+player.getMoney()+"                                   |"+fields[37].line2()+"|");
