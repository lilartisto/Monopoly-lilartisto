public class StartF implements Field{
    private String name;
    private char[] players;

    public StartF( String name ){
        this.name = name;
    ...
    public void doWhenStand( Player player ){
        ...
        Map.printMap(player);
        //pole nic nie robi
        //powinien dostac 200 ale to jest za przejscie przez start a nie za staniecie na nie
        //200+ zaimplementuje gdzie indziej
    }
